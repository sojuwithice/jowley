...
<div class="container my-5">
    <div class="row">
        ...
        <div class="col-md-6">
        <img id="mainImage" src="image/fuzzy-flower.jpg" class="img-fluid rounded" alt="Mini Fuzzy Flower">
    ...
    <span class="text-dark">(10 ratings)</span> | <span class="text-success">30+ sold</span>
</p>
