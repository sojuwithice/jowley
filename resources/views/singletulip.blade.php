...
<div class="container my-5">
    <div class="row">
        ...
        <div class="col-md-6">
            <img src="image/single-tulip.jpg" class="img-fluid rounded" alt="Single Tulip Crochet Bouquet">
        </div>

      
        <div class="col-md-6">
            <h1 class="fw-bold">Single Tulip Crochet Bouquet</h1>
            <p class="text-warning fw-bold">
    4.7 
    <i class="fas fa-heart text-pink"></i>
    <i class="fas fa-heart text-pink"></i>
    <i class="far fa-heart text-black"></i>
    <span class="text-dark">(290 ratings)</span> | <span class="text-success">20+ sold</span>
</p>

            <h3 class="text-danger">₱130.00</h3>
            <p>Adorable crochet bouquet, perfect for adding a soft, handmade touch to your space!</p>
