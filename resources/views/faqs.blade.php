...
<body class="bg-white min-h-screen">
  <header class="border-b border-pink-500">
    ...
    <nav class="max-w-7xl mx-auto flex items-center justify-center space-x-10 px-4 py-3 bg-white">
      <a href="#" class="text-black text-base hover:underline">Home</a>
      <a href="#" class="text-black text-base hover:underline">Products</a>
      <a href="#" class="text-black text-base hover:underline">FAQs</a>
